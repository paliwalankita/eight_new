...
public class StationsLikeAdapter extends RecyclerView.Adapter<StationsLikeAdapter.MyViewHolder> {
...
//        width = viewGroup.getMeasuredWidth();
        View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.stations_like_adapter, viewGroup, false);
