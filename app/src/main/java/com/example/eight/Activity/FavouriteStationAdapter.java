...
public class FavouriteStationAdapter extends RecyclerView.Adapter<FavouriteStationAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView users_listen_count, users_follow_count, mj_rating, station_name, mj_name ;
        ImageView stationImage, mj_image;
        LinearLayout parentLayout;
        RelativeLayout stationParentLayout;
...
//        width = viewGroup.getMeasuredWidth();
        View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.favourite_stations_adapter, viewGroup, false);
